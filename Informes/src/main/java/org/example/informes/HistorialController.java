...
public class HistorialController {
    ...
    // Método para generar el informe del historial médico
    @FXML
    public void generateReport() {
        try {
            String patientId = pacienteIdField.getText();

            if (patientId.isEmpty()) {
                System.out.println("Por favor, completa el campo de ID del paciente.");
                return;
            }
